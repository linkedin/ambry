 ...
 */
public class MockConnection implements ConnectedChannel {
  ...
  public ChannelOutput receive() throws IOException {
    ...
    if (metadataRequest != null) {
      ...
      response =
          new GetResponse(1, "replication", responseInfoList, new MockSend(buffersToReturn), ServerErrorCode.No_Error);
      getRequest = null;
    }
