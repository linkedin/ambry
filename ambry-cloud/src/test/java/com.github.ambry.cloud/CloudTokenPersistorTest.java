...
public class CloudTokenPersistorTest {
  ...
  public void basicTest() throws Exception {
    ...
    CloudTokenPersistor cloudTokenPersistor = new CloudTokenPersistor("replicaTokens", mountPathToPartitionInfoList,
        new ReplicationMetrics(new MetricRegistry(), Collections.emptyList()), clusterMap, new FindTokenFactoryFactory(blobIdFactory, replicationConfig), cloudDestination);
