...
public interface CloudDestinationFactory {
   ...
   * @param verifiableProperties the {@link VerifiableProperties} for the destination to be created.
   * @throws IllegalStateException if the {@link CloudDestination} instance cannot be created.
   */
  CloudDestination getCloudDestination(VerifiableProperties verifiableProperties) throws IllegalStateException;
}
