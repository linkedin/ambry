...
public class PutMessageFormatInputStream extends MessageFormatInputStream {
  ...
  public PutMessageFormatInputStream(StoreKey key, BlobProperties blobProperties, ByteBuffer userMetadata,
      InputStream data, long streamSize, short version)
    ...
    switch (version) {
      case MessageFormatRecord.Message_Header_Version_V1:
        ...
        MessageFormatRecord.MessageHeader_Format_V1
            .serializeHeader(buffer, blobPropertiesRecordSize + userMetadataSize + blobSize,
      ...
      default:
        throw new MessageFormatException(
            "Unknown version " + version + ", cannot create PutMessageFormatInputStream",
  ...
  public PutMessageFormatInputStream(StoreKey key, BlobProperties blobProperties, ByteBuffer userMetadata,
      ...
      throws MessageFormatException {
    this(key, blobProperties, userMetadata, data, streamSize, MessageFormatRecord.Message_Header_Version_V1);
  }
}
