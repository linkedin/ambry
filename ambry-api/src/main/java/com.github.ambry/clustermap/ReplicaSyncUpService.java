 ...
 */
public interface ReplicaSyncUpService {
   ...
   * @param chaser the replica which is catching up with precursor
   * @param precursor the replica which is in leading position
   ...
   */
  boolean updateLagBetweenReplicas(ReplicaId chaser, ReplicaId precursor, long lagInBytes);
  ...
  /**
   * Bootstrap on given replica is complete. This method will count down the latch.
