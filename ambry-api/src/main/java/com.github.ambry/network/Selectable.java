...
public interface Selectable {
   ...
   */
  public void connect(int id, InetSocketAddress address, int sendBufferSize, int receiveBufferSize) throws
                                                                                                    IOException;
   ...
   * @throws IOException
   */
  public void poll(long timeout, List<Send> sends) throws IOException;
   ...
   */
  public List<Receive> completedReceives();
