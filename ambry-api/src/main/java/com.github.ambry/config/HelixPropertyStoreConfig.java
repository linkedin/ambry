...
public class HelixPropertyStoreConfig {
  ...
  public static final String HELIX_ZK_CLIENT_CONNECTION_TIMEOUT_MS = HELIX_PROPERTY_STORE_PREFIX + "zk.client.connection.timeout.ms";
  public static final String HELIX_ZK_CLIENT_SESSION_TIMEOUT_MS = HELIX_PROPERTY_STORE_PREFIX + "zk.client.session.timeout.ms";
  ...
  public HelixPropertyStoreConfig(VerifiableProperties verifiableProperties) {
    zkClientConnectionTimeoutMs =
        verifiableProperties.getIntInRange(HELIX_ZK_CLIENT_CONNECTION_TIMEOUT_MS, 20 * 1000,
            1, Integer.MAX_VALUE);
    zkClientSessionTimeoutMs =
        verifiableProperties.getIntInRange(HELIX_ZK_CLIENT_SESSION_TIMEOUT_MS, 20 * 1000, 1,
            Integer.MAX_VALUE);
