...
public class MySqlAccountServiceConfig extends AccountServiceConfig {
  ...
  public static final String DATASET_RETENTION_POLICY = MYSQL_ACCOUNT_SERVICE_PREFIX + "dataset.retention.policy";
  ...
  @Config(DATASET_RETENTION_POLICY)
  @Default("")
  public final String datasetRetentionPolicy;
  ...
  public MySqlAccountServiceConfig(VerifiableProperties verifiableProperties) {
    ...
    datasetRetentionPolicy = verifiableProperties.getString(DATASET_RETENTION_POLICY, "");
  }
}
