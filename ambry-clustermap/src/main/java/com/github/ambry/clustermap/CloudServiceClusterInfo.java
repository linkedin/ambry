...
public class CloudServiceClusterInfo extends ClusterInfo {
  /**
   ...
   */
  CloudServiceClusterInfo(ClusterChangeHandler clusterChangeHandler, ClusterMapConfig clusterMapConfig) {
