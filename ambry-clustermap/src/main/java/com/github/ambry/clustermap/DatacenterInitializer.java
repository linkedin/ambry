...
class DatacenterInitializer {
   ...
   * @param helixClusterManager helixClusterManager reference to {@link HelixClusterManager} that creates this class.
   */
  DatacenterInitializer(ClusterMapConfig clusterMapConfig, HelixManager localManager, HelixFactory helixFactory,
    ...
    this.dcName = dcZkInfo.getDcName();
  ...
  public void start() {
    Utils.newThread(() -> {
      try {
        ...
        DcInfo dcInfo = initializeHelixDatacenter();
