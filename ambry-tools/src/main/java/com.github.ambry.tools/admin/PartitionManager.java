  ...
  public static void main(String args[]) {
    try {
      ...
      ArgumentAcceptingOptionSpec<String> hardwareLayoutPathOpt =
              parser.accepts("hardwareLayoutPath", "The path to the hardware layout map")
                    .withRequiredArg()
                    .describedAs("hardware_layout_path")
                    .ofType(String.class);

      ArgumentAcceptingOptionSpec<String> partitionLayoutPathOpt =
              parser.accepts("partitionLayoutPath",
                             "The path to the partition layout map. The file is updated with the new partitions")
                    .withRequiredArg()
                    .describedAs("partition_layout_path")
                    .ofType(String.class)
                    .defaultsTo("");

      ArgumentAcceptingOptionSpec<String> operationTypeOpt =
              parser.accepts("operationType", "The type of operation to perform on the partition. Currently supported" +
                                              "operations are 'AddPartition'")
                    .withRequiredArg()
      ...
      ArgumentAcceptingOptionSpec<Integer> numberOfPartitionsOpt =
              parser.accepts("numberOfPartitionsToAdd", "The number of partitions to add")
                    .withRequiredArg()
                    .describedAs("number_of_partitions_to_add")
      ...
      ArgumentAcceptingOptionSpec<Integer> numberOfReplicasPerDatacenterOpt =
              parser.accepts("numberOfReplicasPerDatacenter", "The number of replicas for the partition per datacenter")
                    .withRequiredArg()
                    .describedAs("number_of_replicas_per_datacenter")
                    .ofType(Integer.class);

      ArgumentAcceptingOptionSpec<Long> replicaCapacityInBytesOpt =
              parser.accepts("replicaCapacityInBytes", "The capacity of each replica in bytes")
                    .withRequiredArg()
                    .describedAs("replica_capacity_in_bytes")
                    .ofType(Long.class);
