...
/**
 * Configuration parameters required by {@link DumpData}
 */
public class DumpDataConfig {

  /**
   * "The file that needs to be dumped. Index file incase of "DumpIndex", "CompareIndexToLog",
   * log file incase of "DumpLog" and replicatoken file in case of "DumpReplicatoken"
   */
  @Config("file.to.read")
  ...
  public DumpDataConfig(VerifiableProperties verifiableProperties) {
    ...
    logStartOffset = verifiableProperties.getInt("log.start.offset", 0);
