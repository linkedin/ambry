...
public class StoreMetrics {
  ...
  public final Timer findAllMessageInfoForKeyResponse;
  ...
  public StoreMetrics(String prefix, MetricRegistry registry) {
    ...
    findAllMessageInfoForKeyResponse = registry.timer(MetricRegistry.name(BlobStore.class, name + "StoreFindAllMessageInfoForKeyResponse"));
