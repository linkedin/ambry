...
import com.github.ambry.rest.MockRestRequestHandlerController;
...
public class NettyMessageProcessorTest {
  ...
  /**
   * Tests for error handling flow when the {@link com.github.ambry.rest.RestRequestHandler} throws exceptions.
   * @throws JSONException
   */
  @Test
