...
import com.github.ambry.rest.MockBlobStorageServiceFactory;
import com.github.ambry.rest.MockNioServerFactory;
...
public class RestServerTest {
  ...
  public void startShutdownTestWithBadComponent()
    ...
    Properties properties = new Properties();
    properties.setProperty("rest.blob.storage.service.factory", MockBlobStorageServiceFactory.class.getCanonicalName());
    properties.setProperty("rest.nio.server.factory", "com.github.ambry.rest.MockNioServerFactory");
  ...
  /**
   * Tests instantiation with bad {@link com.github.ambry.rest.NioServerFactory} class.
   * @throws IOException
   */
  ...
  /**
   * Tests instantiation with bad {@link com.github.ambry.rest.BlobStorageServiceFactory} class.
   * @throws IOException
   */
