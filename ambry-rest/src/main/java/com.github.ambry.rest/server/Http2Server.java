...
package com.github.ambry.rest.server;
...
public final class Http2Server {
    ...
    public static void main(String[] args) throws Exception {
        ...
        if (SSL) {
            ...
            sslCtx = SslContextBuilder.forServer(new File("/Users/zemao/ambry/identity.cert"), new File("/Users/zemao/ambry/identity.key"))
