...
public class SelectorTest {
  ...
  public void setup() throws Exception {
    ...
    this.server.start();
    this.selector = new Selector(new NetworkMetrics(
        new SocketRequestResponseChannel(1,2), new MetricRegistry()), SystemTime.getInstance());
  }
  ...
  public void testNormalOperation() throws Exception {
    ...
    while (responseCount < conns * reqs) {
      ...
      for (NetworkReceive receive : selector.completedReceives()) {
        ...
        assertEquals("Check the request counter",
            responses[(int)receive.getConnectionId()], Integer.parseInt(pieces[1]));
  ...
  private String blockingRequest(long node, String s) throws IOException {
  ...
  private long blockingConnect() throws IOException {
