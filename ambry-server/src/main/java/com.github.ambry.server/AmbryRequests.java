...
public class AmbryRequests implements RequestAPI {
  ...
  public AmbryRequests(StorageManager storageManager, RequestResponseChannel requestResponseChannel,
      ...
      FindTokenFactoryFactory findTokenFactoryFactory, NotificationSystem operationNotification,
      ReplicationManager replicationManager, StoreKeyFactory storeKeyFactory, boolean enableDataPrefetch,
