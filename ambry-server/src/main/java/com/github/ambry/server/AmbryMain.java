...
public class AmbryMain {
  ...
  public static void main(String[] args) {
    ...
    try {
      ...
      VcrClusterAgentFactory vcrClusterAgentFactory = Utils.getObj(cloudConfig.vcrClusterAgentFactoryClass);
      ambryServer = new AmbryServer(verifiableProperties, clusterAgentsFactory, vcrClusterAgentFactory,
