...
public class AmbryRequestsTest {
  ...
  public AmbryRequestsTest()
    ...
    findTokenFactoryFactory =
        new MockFindTokenFactoryFactory(storeKeyFactory, new ReplicationConfig(verifiableProperties));
    storageManager =
        new MockStorageManager(validKeysInStore, clusterMap.getReplicaIds(dataNodeId), findTokenFactoryFactory);
    ...
    ambryRequests = new AmbryRequests(storageManager, requestResponseChannel, clusterMap, dataNodeId,
        clusterMap.getMetricRegistry(), findTokenFactoryFactory, null, replicationManager, null, false,
        storeKeyConverterFactory);
  ...
  private static class MockStorageManager extends StorageManager {
    ...
    MockStorageManager(Set<StoreKey> validKeysInStore, List<? extends ReplicaId> replicas,
        FindTokenFactoryFactory findTokenFactoryFactory) throws StoreException {
