...
public class ServerHardDeleteTest {
  ...
  public void endToEndTestHardDeletes() throws Exception {
    ...
    // old value is 198732 + 14. Increased by 54 when adding two fields(4 BYTE CRC for each field) in blobProperty when putBlob.
    // There are 6 * (4 + 4 + 1). 6 stands for the times for putBlob, 4 stands for 4 extra blobProperty Bytes for each field,
    // 1 bytes for compression flag.
    ...
    // old value is 298416 + 98 + 28. Increased by 81 when adding two fields(4 BYTE CRC for each field) in blobProperty when putBlob.
    // There are 9 * (4 + 4 + 1). 9 stands for the times for putBlob, 4 stands for 4 extra blobProperty Bytes.
