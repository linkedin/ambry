...
public class VcrTestUtil {
  ...
  /**
   * Create a {@link com.github.ambry.cloud.VcrServer}.
   ...
   */
  public static com.github.ambry.cloud.VcrServer createVcrServer(VerifiableProperties properties, ClusterAgentsFactory clusterAgentsFactory,
