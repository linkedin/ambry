 ...
 */
public class HelixPropertyStoreUtils {
   ...
   */
  public static class HelixStoreOperator {
    ...
    public void write(String path, ZNRecord zNRecord) throws Exception {
      ...
      TestUtils.awaitLatchOrTimeout(latch, operationTimeoutMs);
   ...
   */
  public static HelixStoreOperator getStoreOperator(HelixPropertyStoreConfig storeConfig,
   ...
   * @throws InterruptedException
   */
  public static void deleteStoreIfExists(HelixPropertyStoreConfig storeConfig, HelixPropertyStoreFactory storeFactory)
      throws Exception {
